const translations = {
    es: {
      ...
      project_documentation_info: "En esta sección podrás descargar los documentos relevantes del proyecto, como la memoria técnica y las diapositivas de la presentación en formato PDF. Haz clic en los enlaces para obtener los archivos correspondientes.", 
      project_documentation_info_report: "En esta sección podrás descargar la memoria técnica en formato PDF pulsando sobre el botón de descarga.", 
      project_documentation_slides: "En esta sección podrás descargar las diapositivas en formato PDF pulsando sobre el botón de descarga.",
    ...
    en: {
      ...
      project_documentation_info: "In this section, you can download the relevant project documents, such as the technical report and the presentation slides in PDF format. Click the links to download the corresponding files.",
      project_documentation_info_report: "In this section you can download the technical report in PDF format by clicking on the download button.", 
      project_documentation_slides: "In this section you can download the slides in PDF format by clicking on the download button.",
